...
**Current State:**
- **Etsy Offsite Ads implementation in progress** (branch: `codex/etsy-offsite-fee-reconciliation`): Tasks 1–8 are complete; remaining work covers the guarded UI and production backfill runbook. No production database or Etsy account was accessed.
